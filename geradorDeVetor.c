...
/**
 * Ideias propostas:
 * - Fazer com 50 vetores para todos os tamanhos: 100, 1000, 10000 ....
 * - Utilizar um mesmo metodo para imprimir no terminal os resultados por algoritmo de ordenacao
 * - Utilizar valores inteiros negativos e positivos para povoar os vetores de tamanho 50
 */
        ...
        for (incrementaTamanho = 0; incrementaTamanho < casosTeste; incrementaTamanho++) {
            ...
            */
            for (i = 0; i < NUMERO_VETORES; i++) {
                ...
                double tempo = calculaTempoExecucao(vetor, tamanhosPossiveis[incrementaTamanho], escolheAlgoritmo);
