...
projeto: novoGerador.c metodos.h utilitarios.h utilitarios.c insertion_sort.c selection_sort.c bubble_sort.c quick_sort.c merge_sort.c radix_sort.c bucket_sort.c counting_sort.c
	gcc -o projeto novoGerador.c utilitarios.c insertion_sort.c selection_sort.c bubble_sort.c quick_sort.c merge_sort.c radix_sort.c bucket_sort.c counting_sort.c
